...
class ILogger {
 public:
  ...
  virtual void logBellPairInfo(const std::string& event_type, int sequence_number, int partner_addr, quisp::modules::QNIC_type qnic_type, int qnic_index, int qubit_index) = 0;
